...
.EXAMPLE
    PS C:\> .\SP2013EnumNavigationLinks.ps1
    PowerShell Object Model Script Query To Produce A Report On SharePoint Navigation Links.
...
######################## Start Variables ##############################################
$siteURL = "http://YOURURLHERE" #URL to any sites in the web application.
$filePath = "C:\PowerShellScripts\Links.csv" #Change this path to suit your environment
...
$site.dispose()
write-host "Script completed, check your specified file path for the report: $filePath"