<#
.SYNOPSIS
    PowerShell Script to Create and Update Crawl Rules from an XML input File.

.DESCRIPTION
    PowerShell Script to Create and Update Crawl Rules from an XML input File.

.EXAMPLE
    PS C:\> .\SP2013AddCrawlRules.ps1
    PowerShell Script to Create and Update Crawl Rules from an XML input File.

.NOTES
    Requires:   Microsoft.SharePoint.PowerShell
    Resources:  http://ExampleSharePointSite</Rule>; http://sharepointbrainpump.blogspot.ch/2012/10/powershell-howo-creating-and-deleting-crawl-rules.html
#>
