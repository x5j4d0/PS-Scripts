<#
.SYNOPSIS
    SP2013 Delete SP List Items Permanently.
...
.EXAMPLE
    PS C:\> .\SP2013DeleteSPListItemsPermanently.ps1
    Edit the variables section and run to sP2013 Delete SP List Items Permanently.
