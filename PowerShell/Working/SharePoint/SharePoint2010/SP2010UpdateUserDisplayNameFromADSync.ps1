...
$Donain = "*YourDomain*" #Change this domain syntax to match your DC properties
...
Get-SPUser –Web $SPWeb | Where-Object {$_.UserLogin –like $Donain} | Out-File -FilePath $LogFilePrior

## Display a count of all the user accounts for the SPWeb

Get-SPUser –Web $SPWeb | Where-Object {$_.UserLogin –like $Donain} | Measure-Object | Out-File -FilePath $LogFilePrior -Append
...
Get-SPUser –Web $SPWeb | Where-Object {$_.UserLogin –like $Donain} | Out-File -FilePath $LogFileAfter

## Display a count of all the user accounts for the SPWeb

Get-SPUser –Web $SPWeb | Where-Object {$_.UserLogin –like $Donain} | Measure-Object | Out-File -FilePath $LogFileAfter -Append