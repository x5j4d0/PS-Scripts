<#
.SYNOPSIS
    SP2007 Delete SP List Items Permanently.
...
.EXAMPLE
    PS C:\> .\SP2007DeleteSPListItemsPermanently.ps1
    Edit the variables section and run to sP2007 Delete SP List Items Permanently.
