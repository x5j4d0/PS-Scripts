<#
.SYNOPSIS
    PowerShell SharePoint Online Module Script to Perform Bulk Actions from a CSV File (SPOnline).

.DESCRIPTION
    PowerShell SharePoint Online Module Script to Perform Bulk Actions from a CSV File
    (SPOnline).

.EXAMPLE
    PS C:\> .\SPOnlineSiteCollectionCommandsFromCSVInput.ps1
    PowerShell SharePoint Online Module Script to Perform Bulk Actions from a CSV File (SPOnline).
